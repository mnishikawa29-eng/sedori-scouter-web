"""
せどり利益スカウター - Streamlit版 v2.1
中古品フィルター搭載 + 利益ランキング表示
"""
...
DEFAULT_CONFIG = {
    "min_profit_rate": 5.0,
    "exclude_used": True,  # デフォルトで中古品除外ON
...
st.caption("v2.1 中古品フィルター搭載版（100商品データ）| 最終更新: 2026-03-20")
...
st.dataframe(
    df_filtered.style.format({
        ...
        "実質価格": "¥{:,.0f}",
        "利益額": "¥{:,.0f}",
        "利益率(%)": lambda x: format_profit_rate(x)
    }),
